...
class CityscapesDataset_4(CustomDataset):
    """Cityscapes dataset.
    ...
    def __init__(self, **kwargs):
        super(CityscapesDataset_4, self).__init__(
            img_suffix='_leftImg8bit.png',
            #seg_map_suffix='_gtFine_labelIds.png',
            # 原始确实是TrainIds 但是下载下来的数据集发现是Ids
            seg_map_suffix='_gtFine_labelIds_614.png',
            **kwargs)
